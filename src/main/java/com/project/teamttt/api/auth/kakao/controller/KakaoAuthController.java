...
public class KakaoAuthController {
    ...
    @Operation(summary = "카카오 로그인",
            description = "카카오 소셜 로그인 API" +
                    "\n### * 카카오 로그인 요청 순서" +
                    "\n 1. 주소창에 https://kauth.kakao.com/oauth/authorize?client_id=65df1cfa1ecf4e16aaa4809b8f8e4770&redirect_uri=http://15.164.219.102:80/login/oauth2/code/kakao&response_type=code&state= 입력\n" +
                    "\n 2. 카카오 로그인 진행\n" +
